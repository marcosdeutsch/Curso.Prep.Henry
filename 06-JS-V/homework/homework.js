...
function agregarStringInvertida() {
  // Agrega un método al prototype de String que devuelva la misma cadena de 
  //caracteres, pero invertida.
...
//Debe tener un método llamado "detalle" que nos devuelve un objeto con las 
//propiedades de la persona y sus valores.
//Ej: { 
//   Nombre: 'Juan',
//   Apellido: 'Perez',
//   Edad: 22,
...
function crearInstanciaPersona(nombre, apellido, edad, dir) {
  //Con esta función vamos a crear una nueva persona a partir de nuestro
...
function agregarMetodo() {
  //La función agrega un método "datos" a la clase Persona que toma el nombre y 
  //la edad de la persona y devuelve: 
  //Ej: "Juan, 22 años"
